"""
scripts/setup3_graph.py
=======================
ABLATION SETUP 3 - Baseline + BM25 + Graph Retrieval
Features: Vector search + BM25 + Neo4j knowledge graph
          (no Intent Classifier, no Fact Checker)

Run:
    cd "c:/LLM RAG/update promts"
    python scripts/setup3_graph.py
"""
...
import src.agents.v2.nodes
unittest.mock.patch("src.agents.v2.nodes._vector_search", return_value=[]).start()
