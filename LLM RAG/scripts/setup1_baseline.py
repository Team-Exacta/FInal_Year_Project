"""
scripts/setup1_baseline.py
==========================
ABLATION SETUP 1 - Baseline
Features: Vector search ONLY (no BM25, no Graph, no Intent Classifier, no Fact Checker)

Run:
    cd "c:/LLM RAG/update promts"
    python scripts/setup1_baseline.py
"""
...
os.environ["USE_GRAPH_RETRIEVAL"]     = "false"
os.environ["USE_DYNAMIC_THRESHOLDS"]  = "false"
os.environ["USE_FACT_CHECKER"]        = "false"
os.environ["USE_INTENT_CLASSIFIER"]   = "false"

SETUP_NAME = "1_Baseline"
...
print(f"  USE_BM25=false | USE_GRAPH_RETRIEVAL=false")
print(f"  USE_DYNAMIC_THRESHOLDS=false | USE_INTENT_CLASSIFIER=false")
print("=" * 70)
...
# ── Step 2: Run RAG pipeline per question ────────────────────────────────────
...
# ── Step 5: Add user_input / contexts columns for CSV ─────────────────────────
...
log("=" * 70)
log("\n  FEATURE FLAGS:")
log("  USE_BM25=false | USE_GRAPH_RETRIEVAL=false")
log("  USE_DYNAMIC_THRESHOLDS=false | USE_FACT_CHECKER=false | USE_INTENT_CLASSIFIER=false")
