"""
scripts/setup2_bm25.py
======================
ABLATION SETUP 2 - Baseline + BM25
Features: Vector search + BM25 keyword search
          (no Graph, no Intent Classifier, no Fact Checker)

Run:
    cd "c:/LLM RAG/update promts"
    python scripts/setup2_bm25.py
"""
...
print(f"  USE_BM25=true | USE_GRAPH_RETRIEVAL=false")
...
log("=" * 70)
log("\n  FEATURE FLAGS:")
log("  USE_BM25=true | USE_GRAPH_RETRIEVAL=false")
